...
var (
	runFor = flag.Duration("run_for", 0*time.Second,
	...
	poolSize = flag.Int("pool_size", 100, "size of the gRPC connection pool to use for the data client")
	reqCount = flag.Int("req_count", 10000, "number of concurrent requests")
...
*/
			default:
                ...
                tbl.Apply(context.Background(), row, mut)
/*
